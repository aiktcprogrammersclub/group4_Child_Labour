...
<div id="wrap">
			...
			<span style="float:right;margin-right:1=30px">
					    <?php 
								...
								if(isset($_SESSION['name']))
								{
									...
									echo '<div class="fb-share-button" data-href="http://localhost/savechild/home.php" data-layout="icon"></div>';
								}
								else
								{
		...
		<div id="body"><br>
		    <iframe style="margin-left:30px;" scrolling="no" width="890" height="310" src="index.html"></iframe>
			<iframe style="margin-left:30px" width="890" height="500" src="def.php"></iframe>
		</div>
