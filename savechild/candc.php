...
<html>
<head>
<title>Causes and Consequence</title>
...
<div id="wrap">
			...
			<span style="float:right;margin-right:1=30px">
						<?php 
								...
								if(isset($_SESSION['name']))
								{
									...
									echo '<div class="fb-share-button" data-href="http://localhost/savechild/candc.php" data-layout="icon"></div>';
								}
								else
								{
		...
		<div id="body"><br>
			<iframe style="margin-left:30px" width="890" height="800" src="cause.php"></iframe>
		</div>
