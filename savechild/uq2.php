...
<div style="float:right" class="fb-share-button" data-href="http://localhost/savechild/uq2.php" data-width="200" data-type="button_count"></div>
...
echo 
"2.&nbsp;Is poverty major cause of child labour and parental illiteracy<br><br>";
echo "<br><br><b>Comments </b><br>";

@session_start();
if(isset($_SESSION['name']))
{
	echo "<form action='inscom2.php' method='post' name='f' id='f'>";
